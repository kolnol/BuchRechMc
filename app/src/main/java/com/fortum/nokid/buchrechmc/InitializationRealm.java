...
//        answers.add(new Answer(0,"Statistik-undVergleichsrechnung"));
//        answers.add(new Answer(1,"Kosten- und Leistungsrechnung"));
//        answers.add(new Answer(2,"Finanzbuchhaltung"));
//        answers.add(new Answer(3,"Planungsrechnung"));
//
//        Question question1 = new Question(questionStr1, answers, 2, 1, "", false, 1, 2);
//
//
